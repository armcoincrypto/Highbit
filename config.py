...
# Discounts for FIAT payments (USD/AMD) - reduces rate
DISCOUNT_FIAT_HIGH = Decimal(os.getenv("DISCOUNT_FIAT_HIGH", "-0.007"))  # -0.7% for VIP
DISCOUNT_FIAT_LOW = Decimal(os.getenv("DISCOUNT_FIAT_LOW", "-0.010"))    # -1.0% for standard

# Discounts for USDT payments - reduces rate
DISCOUNT_USDT_HIGH = Decimal(os.getenv("DISCOUNT_USDT_HIGH", "-0.009"))  # -0.9% for VIP
DISCOUNT_USDT_LOW = Decimal(os.getenv("DISCOUNT_USDT_LOW", "-0.013"))    # -1.3% for standard
